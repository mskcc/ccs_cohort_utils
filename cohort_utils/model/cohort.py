...
class Cohort:
    def __init__(self,**kwargs):
        ...
        self.deliver_fq = kwargs.pop("deliver_fq", not kwargs.pop("holdBamsAndFastqs",False))
        self.deliver_bam = kwargs.pop("deliver_bam", not kwargs.pop("holdBamsAndFastqs",False))
    ...
    def _validate_data_types(self):
        ...
        for i in self.endUsers:
            assert isinstance(i,str)
        assert isinstance(self.projectTitle,str)
        assert isinstance(self.projectSubtitle,str)
        assert isinstance(self.holdBamsAndFastqs,bool)
        assert isinstance(self.lockCohort,bool)
